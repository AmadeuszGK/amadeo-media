...
class MenuMobile extends React.Component  {
  ...
  render() {
    return(
      ...
      <div className="menu-button" onClick={this.props.passedFunction}>
      <div id="nav-icon3" className={this.props.showMenu ? "open" : ""}>
        <span />
        <span />
        <span />
        <span />
    ...
    <ul>
          <li>
            <Link className="navButton" to="/" onClick={this.props.passedFunction}>
              Strona główna
            </Link>
          </li>
          <li>
            <Link className="navButton" to="/offer-and-pricing" onClick={this.props.passedFunction}>
              Oferta i cennik
            </Link>
          </li>
          <li>
            <Link className="navButton"  to="/portfolio" onClick={this.props.passedFunction}>
              Portfolio
            </Link>
          </li>
          <li>
            <Link className="navButton" to="/about-us" onClick={this.props.passedFunction}>
              O nas
            </Link>
          </li>
          <li>
            <Link className="navButton" to="/contact" onClick={this.props.passedFunction}>
              Kontakt
            </Link>
          </li>
          <li>
