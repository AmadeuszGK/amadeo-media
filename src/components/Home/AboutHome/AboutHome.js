    ...
    <div className="container">
      <div className="about-grid">
        <div className="about-card">
          <svg className="icon" xmlns="http://www.w3.org/2000/svg" id="_x31__x2C_5" x="0px" y="0px" viewBox="0 0 512 512">
            ...
            <g>
              <g>
                <path className="st1" d="M378.33,116.35l20.78-20.78l10.39,10.39l-20.78,20.78L378.33,116.35z"></path>
              </g>
              <g>
                <path className="st1" d="M383.47,163.05l10.39-10.39l20.78,20.78l-10.39,10.  39L383.47,163.05z"></path>
              </g>
              <g>
                <path className="st1" d="M323.72,103.3l10.39-10.39l20.78,20.78l-10.39,10.39L323.72,103.3z"></path>
              </g>
            </g>
            <g>
              <circle className="st0" cx="148.79" cy="123.71" r="33.07"></circle>
            </g>
            <g>
              <path
                className="st0"
            ...
            <g>
              <circle className="st0" cx="325.17" cy="329.5" r="62.47"></circle>
            </g>
            <g>
              <path
                className="st1"
        ...
        <div className="about-card">
          <svg className="icon" xmlns="http://www.w3.org/2000/svg" id="_x31__x2C_5" x="0px" y="0px" viewBox="0 0 512 512">
            ...
            ></path>
            <g>
              <path className="st2" d="M97.45,90.63h36.75v36.75H97.45V90.63z"></path>
              <path
                className="st2"
              ...
              ></path>
              <path className="st2" d="M391.43,90.63h36.75v36.75h-36.75V90.63z"></path>
            </g>
            <path className="st0" d="M288.64,311.12l36.64-53.65l-62.47-144.79l-62.47,144.79l36.64,53.65H288.64z"></path>
            <path className="st0" d="M97.45,90.63h33.07v36.75H97.45V90.63z"></path>
            <path
              className="st0"
            ...
            ></path>
            <path className="st0" d="M391.43,90.63h33.07v36.75h-33.07V90.63z"></path>
            <path className="st1" d="M279.35,151l-16.54-38.32l-62.47,144.79l36.64,53.65h33.07l-36.64-53.65L279.35,151z"></path>
            <path
              className="st2"
            ...
            ></path>
            <path className="st2" d="M137.87,97.98h249.89v22.05H137.87V97.98z"></path>
            <path
              className="st2"
            ...
            ></path>
            <path className="st2" d="M251.79,120.03h22.05V241.3h-22.05V120.03z"></path>
            <path
              className="st2"
        ...
        <div className="about-card">
          <svg className="icon" xmlns="http://www.w3.org/2000/svg" id="_x31__x2C_5" x="0px" y="0px" viewBox="0 0 512 512">
            ...
            <g>
              <g>
                <path className="st1" d="M386.86,97.32l10.39-10.39l20.78,20.78l-10.39,10.39L386.86,97.32z"></path>
              </g>
              <g>
                <path className="st1" d="M446.62,157.09l10.39-10.39l20.78,20.78l-10.39,10.39L446.62,157.09z"></path>
              </g>
              <g>
                <path className="st1" d="M444.02,107.72l20.78-20.78l10.4,10.39l-20.78,20.78L444.02,107.72z"></path>
              </g>
            </g>
            <g>
              <path
            ...
            <g>
              <circle className="st0" cx="204.55" cy="161.77" r="18.37"></circle>
            </g>
            <g>
              <path
                className="st0"
            ...
            <g>
              <circle className="st0" cx="336.85" cy="345.51" r="84.52"></circle>
            </g>
            <g>
              <path
                className="st1"
            ...
            <g>
              <path className="st2" d="M138.41,286.71h88.19v22.05h-88.19V286.71z"></path>
            </g>
            <g>
              <path className="st2" d="M138.41,330.81h73.5v22.05h-73.5V330.81z"></path>
            </g>
            <g>
              <path
                className="st2"
        ...
        <div className="about-card">
          <svg className="icon" xmlns="http://www.w3.org/2000/svg" id="_x31__x2C_5" x="0px" y="0px" viewBox="0 0 512 512">
            ...
            <g>
              <path className="st1" d="M96.06,54.93l20.78-20.78l10.39,10.39l-20.78,20.78L96.06,54.93z"></path>
            </g>
            <g>
              <path className="st1" d="M36.29,114.68L57.08,93.9l10.39,10.39l-20.78,20.78L36.29,114.68z"></path>
            </g>
            <g>
              <path className="st1" d="M38.9,44.53l10.39-10.39l20.78,20.78L59.68,65.31L38.9,44.53z"></path>
            </g>
            <g>
              <path
                className="st0"
            ...
            <g>
              <path className="st2" d="M247.14,79.61h22.05v352.78h-22.05V79.61z"></path>
            </g>
            <g>
              <path className="st2" d="M81.78,244.98h352.78v22.05H81.78V244.98z"></path>
            </g>
            <g>
              <path
                className="st2"
      ...
      <div className="about-info">
        ...
        <p className="text">
          ...
          jednego z liderów branży gamblingowej w Polsce - firmie Promatic...
        </p>
        <div className="cta">
