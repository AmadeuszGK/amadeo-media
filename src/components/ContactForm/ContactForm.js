...
const ContactForm = () => (
    ...
    >
        ...
        <p>Skontaktuj się z <b className="bold">Amadeo Media</b></p>
        ...
        <textarea className="form__input form__input--message" placeholder="Wiadomość..." type="text"></textarea>
        <div className="checbox--wrapper">
            <input className="checkbox" type="checkbox" />
            <p className="privacy-policy">Akceptuję <Link to="/portfolio">politykę prywatności</Link> itd</p>
        </div>
